...
var EventHandler = (function(_React$Component) {
    ...
    function EventHandler(props) {
        ...
        _this.handleCtrlDown = _this.handleCtrlDown.bind(_this);
        _this.handleCtrlUp = _this.handleCtrlUp.bind(_this);
    ...
    _createClass(EventHandler, [
        {
            ...
            value: function componentDidMount() {
                ...
                var handlers = {
                    ...
                    keydown: this.handleCtrlDown,
                    keyup: this.handleCtrlUp,
                    contextmenu: this.handleContextMenu
                };

                Object.keys(handlers).forEach(function(type) {
                    var handlerFunc = handlers[type];
                    _this2.eventHandlerRef.addEventListener(type, handlerFunc, {
                        passive: false
                    });
                });
            }
        ...
        {
            key: "handleCtrlDown",
            value: function handleCtrlDown(e) {
                e.preventDefault();
                if (e.key === "Control") {
                    this.setState({
                        isCtrlDown: true
